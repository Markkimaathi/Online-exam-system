        ...
        ButtonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (EditTextUserName.getText().toString().isEmpty() ||
                    ...
                    Toast.makeText(user_register.this, "Fields can't be blank", Toast.LENGTH_SHORT).show();
                }
                else if (!EditTextPassword.getText().toString().equals(EditTextConfirmPassword.getText().toString())) {
                    Toast.makeText(user_register.this, "Password and Confirm Password should match", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    if (dbHelper.RegisterUser(user)) {
                        ...
                        Toast.makeText(user_register.this, "User Registration Failed!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
